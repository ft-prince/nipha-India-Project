# screen_app/management/commands/setup_brg_assembly.py
from django.core.management.base import BaseCommand
from screen_app.models import Product, AssemblyStage, AssemblyProcess, BillOfMaterial, ProductMedia, Station
